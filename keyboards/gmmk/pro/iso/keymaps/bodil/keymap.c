...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT( // Base layer
        ...
        X_LMOD,  KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, KC_RCTL, X_RMOD,  KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [1] = LAYOUT( // Function keys (LMOD)
        ...
        _______, _______, _______,                            KC_MPLY,                            KC_APP,  _______, MO(3),   KC_HOME, KC_PGDN, KC_END
    ),
    ...
    [2] = LAYOUT( // Unicode typography / intl (RMOD)
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, X_ELLIP, _______,          _______, KC_PGUP, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [1] = {
        ...
        _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, _____,        _____, C_L_1, _____,
        _____, _____, _____,                      _____,                      _____, _____, C_L_3, C_L_1, C_L_1, C_L_1,
    ...
    [2] = {
        ...
        _____, _____, _____, _____, _____, _____, _____, _____, _____, _____, C_L_2, _____,        _____, C_L_1, _____,
